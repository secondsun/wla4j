...
public class Test65816IncludeData {
  ...
  public void basicInclude() throws IOException {
    ...
    String expectedOutput = IOUtils
        .toString(Test65816IncludeData.class.getClassLoader().getResourceAsStream("preprocess.out"),
            "UTF-8");
  ...
  public void multiInclude() throws IOException {
    ...
    data.includeFile(Test65816IncludeData.class.getClassLoader().getResourceAsStream("main.s"),
        "main.s", 0);
    data.includeFile(Test65816IncludeData.class.getClassLoader().getResourceAsStream("defines.i"),
        "defines.i", 1);
    data.includeFile(

...
public class SourceDataLine {
    ...
    /**
     * This is the actual source.  The preprocessor removes comments, white space etc.  Additionally the system may expand macros and things from a single line of source from a source file.  Therefore multiple data lines may be generated from an original source line.

...
public final class TokenUtil {
  ...
  public static String getLabelName(Token token) {
    ...
    // I'm leaving this in, @ are child labels and _ are local labels.  I don't think it should be
    // part of their name,
    // but it makes parsing easier
    //    if (labelString.matches("__+") || labelString.matches("_+f") ||
    // labelString.matches("_+b")) {
